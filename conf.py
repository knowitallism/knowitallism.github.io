...
BLOG_AUTHOR = "Joshua Hernandez"  # (translatable)
BLOG_TITLE = "Joshua Hernandez's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://joshuahernandezblog.com/"
...
# is in the manual.
COMMENT_SYSTEM_ID = "joshuahernandezblog"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-107266843-1"></script>
<script>
